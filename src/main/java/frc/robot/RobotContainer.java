...
public class RobotContainer {
  ...
  public Gamepad Driver = new Gamepad(0, "driver-layout.txt");
  ...
  private void configureButtonBindings() {
    ...
    Driver.a.whenPressed(new ToggleLED(greenlight));
    Driver.x.toggleWhenPressed(new ArcadeDrive(Driver, m_romiDrivetrain));
  }
